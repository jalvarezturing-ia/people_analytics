...
<div class="info-card vertical">
    <h4 class="title-wish"><a href="<?php echo base_url("/home/nomina"); ?>">Periodo por bancos > </a>
        ...
        <div class="dropdown-menu acciones">
            <!-- <a href='#' class='dropdown-item'  onclick="nomina(event, '<?php echo $año ?>', '<?php echo $mes ?>')" data-toggle="tooltip" class="nav-link" data-placement="bottom" title="Cargar un excel y generar datos de nómina">
            <i class='fas fa-file-alt'></i> Crear excel de nómina
        </a>-->
            <a href='<?php echo base_url("/home/archive/$año/$mes/$estado/$inicio/$fin"); ?>' class='dropdown-item'
                data-toggle="tooltip" class="nav-link" data-placement="bottom"
                title="Cargar un excel y generar datos de nómina">
                <i class='fas fa-file-alt'></i> Crear excel de nómina
            </a>
        ...
        <?php foreach ($periodo as $data): ?>
            <div class="card" style=" border-radius: 1rem; box-shadow: rgb(202, 206, 210) 0px 20px 30px -10px;">
                ...
                <div class=" card-body" style="background-color: #F1F1F1 ;">
                    ...
                    <?= $data->mes; ?>
                    <div class="line"> </div>
                    <strong><span class="status-circle"></span> Colaboradores:</strong>
                    <?= $data->cantidad_registros; ?>
                    <a href="<?php echo base_url("/home/periods/$año/$mes/$data->nombre_banco/$estado/$inicio/$fin"); ?>"
                        class="card-box-footer" style="text-align: center; float: right; color: #3498db;"> <i
