...
<div class="info-card vertical" id="allTitle">
    ...
    <div class="col-md-3 " style="" id="controlButtons">
        <select name="onboardings" id="onboardings" class="form-control" style="border-radius: 1rem;"
            ...
            <option value="sbancarios">Apoyo economico</option>
            <option value="beneficiario">Universidad</option>
        </select>
    </div>
    <div>
        <!-- <div class="card-header" style="text-align: center;">
            <strong>
                <i class="fas fa-edit"></i> <?= $nombre . " " . $ap . " - " . $puesto; ?>
            </strong> <br><br>
            <a href="#" class="ver-periodo-btn" onclick="mostrarSeccion('info')" id="infoBtn">Información personal </a>|
            ...
            <hr>
            <a href="#" class="ver-periodo-btn" onclick="mostrarSeccion('domicilio')" id="domicilioBtn">C.Domicilio</a>
            |
            ...
            <a href="#" class="ver-periodo-btn" onclick="mostrarSeccion('sbancarios')" id="bancariosBtn">Apoyo
                economico</a> |
            <a href="#" class="ver-periodo-btn" onclick="mostrarSeccion('beneficiario')"
                id="beneficiarioBtn">Universidad</a>
        </div> -->
                ...
                <?php foreach ($colaborador as $data):
                    ...
                    <div class="mb-5" style="text-align:center;">
                        ...
                        if ($data->foto_perfil == 'perfil.png' || $data->foto_perfil == NULL) {
                            ...
                            echo "<img src='" . base_url('/fotos_colab/' . $data->foto_perfil) . "' class='rounded-circle img-fluid' style='width: 80px; height: 80px; object-fit: cover;'>";
                        }
                        ?>

                        <!--ELIMINAR UN COLABORADOR-->
                        <a href="" onclick="baja(event, <?php echo $data->id_usuario; ?>)" class="ver-periodo-btn1"
                            id="baja" style="float: right; margin-top: 20px">
                ...
                <form id="bancariosForm" action="<?php echo base_url("home/nomina/savedatabank"); ?>" method="post"
                    ...
                    <?php foreach ($nomina as $nominas): ?>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="telefono" class="col-sm-2 col-form-label">Numero de cuemta:</label>
                            <div class="col-sm-4">
