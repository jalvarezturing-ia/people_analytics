              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form id="login-form" action="<?php echo base_url('/validpass'); ?>" method="POST">
                    ...
                    <h5 class="fw-normal mb-3 pb-3" style="text-align:center;">Guarda tu nueva contraseña</h5>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="hidden" name="id_usuario" class="form-control form-control-lg"
                        value="<?= $id_usuario ?>" />
                      <label class="form-label" for="form2Example17">Ingresa tu nueva contraseña</label>
                    </div>

                    <div class="form-outline mb-4">
                      <input type="password" id="password" name="vpassword" class="form-control form-control-lg"
                        required />
                      <label class="form-label" for="password">Valida tu contraseña</label>
                    </div>
                    ...
                    <div class="pt-1 mb-4">
                      <button type="submit" class="btn btn-primary btn-lg"
                        style="display: block; margin: 0 auto; background-color: #1371C7; ">Guardar</button>
                    </div>
