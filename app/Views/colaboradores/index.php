...
<div class="container">
    <div class="info-card vertical">
        <h4 class="title-wish"> Dashboard | Página principal </h4>
        <div class="line"> </div>
        <div class="ag-courses_item" id="ndnd">
            <a href="<?php echo base_url("/home/assistence"); ?>" class="ag-courses-item_link">
        ...
        <div id="cont_d01191e91e3d6d47a29f09614ea14049"></div>
        <br>
        <img src="<?php echo base_url('gifs/kik.png'); ?>" alt="Descripción de la imagen" id="clientimg">
    </div>

    <div class="info-card small">
        <h4 class="title-wish">Dashboard | Calendario</h4>
        <div class="line"></div>
        <div id='calendar'></div>
    </div>

    <div class="info-card small">
        <h4 class="title-wish">Dashboard |Últimos informes</h4>
        <div class="line"></div>
...
<script type="text/javascript" async src="https://www.meteored.mx/wid_loader/d01191e91e3d6d47a29f09614ea14049"></script>
<script>
