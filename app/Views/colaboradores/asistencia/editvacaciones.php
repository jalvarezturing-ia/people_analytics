...
<div class="info-card vertical">
    ...
    <div>
        <div class="card-body" id="nuevoSection">
            <form id="formulario" action="<?php echo base_url("/home/savevacasedit"); ?>" method="post"
                ...
                <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="user_id" class="form-control" value="<?=$id_user ?>" required readonly>
