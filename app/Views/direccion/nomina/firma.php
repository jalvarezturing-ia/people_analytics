...
<div class="info-card vertical">
    <h4 class="title-wish"><a href="<?php echo base_url("home/signature/$año/$mes/$estado/$inicio/$fin"); ?>">
            <?= $nombreB; ?> >
        </a>
        <?=  $in . " a " . $fn; ?>
        ...
        <div class="dropdown-menu acciones">    
            <a href='<?php echo base_url ("home/admit/$año/$mes/$nombreB/$estado/$inicio/$fin"); ?>' class='dropdown-item'>
...
-->
    ...
    <a href="<?php echo base_url("home/signature/$año/$mes/$estado/$inicio/$fin"); ?>" class="ver-periodo-btn1">Retroceder</a>
</div>
