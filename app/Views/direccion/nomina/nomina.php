...
<div class="info-card vertical">
    <h4 class="title-wish"><a href="<?php echo base_url("home/index/history"); ?>">Periodo por bancos > </a>
        <?=  $in . " a " . $fn; ?>
        ...
        <?php foreach ($periodo as $data): ?>
            <div class="card" style=" border-radius: 1rem; box-shadow: rgb(202, 206, 210) 0px 20px 30px -10px;">
                ...
                <div class=" card-body" style="background-color: #F1F1F1 ;">
                    ...
                    <a href="<?php echo base_url("/home/banks/$año/$mes/$data->nombre_banco/$estado/$inicio/$fin");?>" class="card-box-footer" style="text-align: center; float: right; color: #3498db;"> <i class="fa fa-arrow-circle-right"></i></a>
                    <div class="line" ></div>
    ...
    <a href="<?php echo base_url("home/index/history"); ?>" class="ver-periodo-btn1">Retroceder</a>
</div>
